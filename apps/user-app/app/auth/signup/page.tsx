...
import { Mail, User, Phone, Loader2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-6 p-10 bg-white rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign up for a FinX account to get started
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm">
            <p className="text-gray-600">
              ...
              <Link href="/auth/login" className="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-150 ease-in-out">
                Sign in
              </Link>
            </p>
          </div>
